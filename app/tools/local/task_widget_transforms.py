"""Widget state-poll transforms for Automation tools.

Consumed by ``widgets/schedule_prompt/template.yaml`` and
``widgets/define_pipeline/template.yaml`` -> ``state_poll.transform``.
