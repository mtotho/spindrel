...
def _bot_to_out(
    ...
    *,
    ...
    return BotOut(
        ...
        memory_hygiene_enabled=getattr(bot, "memory_hygiene_enabled", None),
        ...
        memory_hygiene_target_hour=getattr(bot, "memory_hygiene_target_hour", None),
        memory_hygiene_extra_instructions=getattr(bot, "memory_hygiene_extra_instructions", None),
        skill_review_enabled=getattr(bot, "skill_review_enabled", None),
        skill_review_interval_hours=getattr(bot, "skill_review_interval_hours", None),
        skill_review_prompt=getattr(bot, "skill_review_prompt", None),
        skill_review_only_if_active=getattr(bot, "skill_review_only_if_active", None),
        skill_review_model=getattr(bot, "skill_review_model", None),
        skill_review_model_provider_id=getattr(bot, "skill_review_model_provider_id", None),
        skill_review_target_hour=getattr(bot, "skill_review_target_hour", None),
        skill_review_extra_instructions=getattr(bot, "skill_review_extra_instructions", None),
        ...
        carapaces=getattr(bot, "carapaces", []),
    )
