...
def validate_webhook_url(url: str) -> None:
    """Basic SSRF validation — reject obviously internal URLs."""
    ...
    if host.startswith("169.254.") or host.startswith("10.") or host.startswith("192.168."):
        raise ValueError("URL must not point to private network addresses")
    if host.startswith("172."):
        ...
        if len(parts) >= 2:
            try:
                ...
                second_octet = -1  # not an IP, e.g. 172solutions.com
