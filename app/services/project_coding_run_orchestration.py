    ...
    *,
    ...
    if loop_policy:
        ...
        loop_block = (
            ...
            "- This continuation may have a fresh task/session and, for isolated runs, a fresh prepared worktree/private Docker daemon.\n"
            "- Reuse the same logical work branch, PR/handoff, Project source context, dependency contract, and continuation lineage.\n"
            "- Do not create a replacement PR or unrelated branch unless the handoff tool reports that reuse is impossible.\n"
