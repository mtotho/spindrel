...
SETTINGS_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "MEMORY_HYGIENE_ENABLED": {"group": "Memory & Learning", "label": "Enabled", "description": "Enable periodic memory hygiene jobs for workspace-files bots. Bots review cross-channel memory, promote stable facts, prune stale entries, and consolidate skills.", "type": "bool"},
