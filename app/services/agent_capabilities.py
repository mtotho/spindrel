...
SKILL_OPPORTUNITY_SKILL_LABELS: dict[str, str] = {
    ...
    "project": "Project (cluster index)",
    "project/setup/init": "Project init",
    "project/setup/blueprint": "Project blueprint",
    "project/plan/prd": "Project PRD",
    "project/plan/run_packs": "Project Run Packs",
    "project/intake": "Project intake",
    "project/runs/implement": "Project implementation runs",
...
def _skill_opportunity_payload(manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    if planning.get("active") and project.get("attached"):
        recommendations.append(_skill_recommendation(
            ...
            skill_ids=["project", "project/plan/run_packs", "project/intake"],
            reason="A Project-bound planning session should follow the Project lifecycle before publishing Run Packs.",
            when_to_load="Before turning a planning conversation, PRD, rough issue list, or multi-part track into Project Run Packs.",
            enrolled=enrolled,
        ))
