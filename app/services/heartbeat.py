...
- If a spatial widget preview tool is available, dry-run your exact intended widget changes before mutating. Spatial widget mutation tools require a matching preview, and you should avoid changes that make overlap, clipping, or duplicate low-signal widgets worse.
