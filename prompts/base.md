...
- **Tools**: You have access to tools via function calling. Use them to take action rather than speculating. Use get_tool_info to discover tools not yet loaded.{skills_section}{memory_section}{knowledge_section}{delegation_section}
