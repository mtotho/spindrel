...
description: >
  ...
  layout_mode, and channel.config JSONB keys covered by the allowlist.
use_when: >
...
triggers: channel config, too noisy, too quiet, turn off automations, channel layout, pipeline_mode, layout_mode
category: core
---
