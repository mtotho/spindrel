...
class TestKindPayloadPairing:
    ...
    def test_all_kinds_have_a_required_payload_class(self):
        ...
        cases: dict[ChannelEventKind, object] = {
            ...
            ChannelEventKind.TURN_STREAM_THINKING: TurnStreamThinkingPayload(bot_id="x", turn_id=_tid, delta="hm"),
            ...
            ChannelEventKind.LLM_STATUS: LlmStatusPayload(bot_id="x", turn_id=_tid, status="retry"),
            ChannelEventKind.EPHEMERAL_MESSAGE: EphemeralMessagePayload(message=_msg(), recipient_user_id="U123"),
            ChannelEventKind.MODAL_SUBMITTED: ModalSubmittedPayload(callback_id="cb", submitted_by="U123", values={}),
            ChannelEventKind.WIDGET_RELOAD: WidgetReloadPayload(pin_id=uuid.uuid4()),
            ChannelEventKind.SESSION_PLAN_UPDATED: SessionPlanUpdatedPayload(session_id=uuid.uuid4(), reason="updated", state={}),
