...
class E2EClient:
    ...
    async def list_project_review_sessions(self, project_id: str) -> list[dict]:
        """GET /api/v1/projects/{id}/coding-runs/review-sessions."""
        resp = await self._client.get(f"/api/v1/projects/{project_id}/coding-runs/review-sessions")
        resp.raise_for_status()
        return resp.json()
