...
For completed rewrites, see [[test-quality]] "Shipped phases" table.
...
- [[test-quality]] — active track, shipped phases, open seams, Phase N
- [[coverage-gaps]] — 127 uncovered routes + critical service symbols (orthogonal axis; still live)
