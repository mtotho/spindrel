...
| `core/command_center_native` | `native_widget` | `app/services/native_app_widgets.py` | Current | Optional native Mission Control widget for mission load, bot lanes, Attention signals, and spatial readiness. |
