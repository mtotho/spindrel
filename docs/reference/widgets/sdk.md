---
title: window.spindrel SDK reference
summary: Full reference for the window.spindrel API — identity, authed network, workspace files, data/state JSON, bus, stream, cache, ui helpers, form, autoReload.
tags: [widgets, reference, sdk]
---
