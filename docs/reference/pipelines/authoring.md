---
title: Pipeline authoring reference
summary: Complete reference for authoring task pipeline steps — JSON schema, the five step types (exec/tool/agent/user_prompt/foreach), params, templates, conditions, failure handling, and worked examples.
tags: [pipelines, reference, automation]
---
