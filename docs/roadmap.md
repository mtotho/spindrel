...
| Agent Quality Observability | v1 shipped 2026-05-03 | Deterministic post-turn trace auditor emits versioned `agent_quality_audit` findings for missed inline images, current facts without lookup, and tool-surface drift; Daily Health surfaces counts; `audit_trace_quality` supports admin/scheduled re-audit. | [[agent-quality-observability]] |
