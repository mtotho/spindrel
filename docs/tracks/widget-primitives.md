---
tags: [spindrel, track, widgets, yaml, integrations]
status: active
...
- Canonical guide: `spindrel/docs/guides/widget-system.md`
- Design spec: `spindrel/docs/guides/ui-design.md`
- Existing primitives: `spindrel/ui/src/components/chat/renderers/ComponentRenderer.tsx`
- Widget preset engine: `spindrel/app/services/widget_presets.py`
- Frigate port target: `spindrel/integrations/frigate/`
...
- Related: [[widgets]], [[widget-dashboard]], [[integration-contract]]
