---
tags: [spindrel, track, docs, active]
status: active
...
- Demoted `vault/Projects/spindrel/How Discovery Works.md` from maintained explainer to pointer page so the vault no longer competes with the canonical docs on runtime behavior.
...
| Phase | Area | Status |
|---|---|---|
| A | Screenshot punch list — staged + captured | **in progress** — tooling landed 2026-04-24 at `scripts/screenshots/`; flagship 8 specs + stagers + docker-exec helpers ready. Awaits first real capture run against the e2e instance. See session log `Sessions/spindrel/2026-04-24-22-screenshot-pipeline-scaffold.md`. |
...
- Current docs inventory: `/home/mtoth/personal/spindrel/docs/`
- Current images: `/home/mtoth/personal/spindrel/docs/images/` (37 files)
...
- New features since 2026-04-07: session logs in `vault/Sessions/spindrel/2026-04-{12..19}-*.md`
