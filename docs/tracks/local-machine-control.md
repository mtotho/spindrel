---
tags: [spindrel, track, local-control, integrations]
status: active
created: 2026-04-23
...
- `cd spindrel/ui && node --test src/components/chat/renderArchitecture.test.ts 'app/(app)/channels/[channelId]/sessionHeaderChrome.test.ts'`
- `cd spindrel/ui && node --test src/lib/machineControlSetup.test.ts`
- `cd spindrel/ui && node --test src/lib/machineControlApiPaths.test.ts`
- `cd spindrel/ui && ./node_modules/.bin/tsc --noEmit --pretty false`
- `cd spindrel/ui && npx tsc --noEmit` after the admin machine-center UI refresh.
- `pytest tests/unit/test_local_companion_provider.py -q`
- `PYTHONPYCACHEPREFIX=/tmp/spindrel-pycache python -m py_compile integrations/local_companion/client.py`
- `pytest tests/unit/test_local_machine_control_phase5a.py -q`
- `PYTHONPYCACHEPREFIX=/tmp/spindrel-pycache python -m py_compile app/tools/local/machine_control.py tests/unit/test_local_machine_control_phase5a.py`
...
- `cd spindrel/ui && npx tsc -p tsconfig.machine-tests.json --pretty false`
- `cd spindrel/ui && node --test .machine-test-dist/profileControls.test.js`
- `cd spindrel/ui && npx tsc --noEmit --pretty false`
- `cd spindrel/ui && npx tsc -p tsconfig.chat-tests.json --pretty false`
- `cd spindrel/ui && node --test .chat-test-dist/src/components/chat/toolTranscriptModel.test.js .chat-test-dist/src/components/chat/renderArchitecture.test.js`
- `pytest tests/unit/test_local_machine_control_phase5a.py -q`
