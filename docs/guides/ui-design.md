...
- **Progress and risk use shared meters.** Cost, quota, forecast, and capacity surfaces should use `SettingsMeter` for current/projected state. Do not create page-local progress bars unless the shared meter is missing a necessary capability.
