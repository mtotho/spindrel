...
1. Build a proper `todo` tool (DB-backed) — create/list/complete/delete todos per bot or channel. Replaces this markdown file. Any bot can use it regardless of filesystem access.
