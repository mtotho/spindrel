...
These two together are the "this doesn't work" signal on the Phase 3 dock MVP. Any Phase 4 consumer (home-screen app-shell dock, every settings-page mount) inherits these bugs until fixed.
