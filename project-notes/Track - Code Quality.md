...
status: active
created: 2026-04-09
updated: 2026-04-29 (task exec host seam shipped)
---
...
**Live queue after the task-exec host pass:**
...
2. **Next verify-first architecture target.** Re-scan before choosing; likely candidates are context assembly / context admission, or another current hot file if fresh Locality pressure is higher than the remaining task facade work.
