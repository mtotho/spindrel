...
| Agent-first capability surface | integration doctor 2026-04-30 | Machine-readable `/api/v1/agent-capabilities` plus `list_agent_capabilities` / `run_agent_doctor`; UI readiness now covers API/tools/skills/Project/harness/widgets/integrations, while repo-local `.agents/skills` guide outside/dev agents without becoming runtime bot skills. | [[Track - Mission Control Vision]] / `docs/guides/discovery-and-enrollment.md` |
