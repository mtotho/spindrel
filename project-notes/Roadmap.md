...
| Agent-first capability surface | v1 2026-04-29 | Machine-readable `/api/v1/agent-capabilities` plus `list_agent_capabilities` / `run_agent_doctor`; scoped API catalog now carries OpenAPI params/body/response hints and `call_api` accepts structured JSON bodies. | [[Track - Mission Control Vision]] / `docs/guides/discovery-and-enrollment.md` |
