...
- Agent coding runs: add automatic branch/MR helpers, richer run progress, and native e2e/screenshot target configuration before relying on this for unattended feature work.
