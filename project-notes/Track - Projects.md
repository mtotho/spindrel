...
- Blueprint editor depth: move beyond the compact create form into richer editing for repo declarations, starter files, env defaults, and required-secret metadata.
