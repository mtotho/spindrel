...
status: active
updated: 2026-04-27 (GitHub repo dashboard + full-page pin polish)
---
...
- **Command Center joined the native dashboard/world set** (2026-04-27) — `core/command_center_native` is an optional native widget for the same operations read model as `/hub/command-center`: assigned Attention work, next heartbeat state, upcoming work, and recent reports. It is convenience UI only and does not export prompt context.
