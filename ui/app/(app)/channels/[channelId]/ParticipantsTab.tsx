...
import { SpatialPolicyStatusRow } from "./SpatialBotPolicyControls";
  ...
  return (
    <>
      ...
      <Section
        ...
        description="Spatial run policy now lives in Heartbeat because it governs background turns. This roster only shows which bots have spatial context enabled."
      >
        <SpatialPolicyStatusRow
          channelId={channelId}
          botId={primaryBotId}
