...
export function DreamingTab() {
  ...
  // Map bot configs by id for toggle state
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div>
        ...
        <span style={{ fontSize: 11, color: t.textDim, lineHeight: "17px", display: "block", marginBottom: 12 }}>
          Toggle dreaming per bot. "Inherit" uses the global default.
          ...
          {data.bots.map((bot) => {
            ...
            return (
              ...
              >
                ...
                {/* Status info */}
                <span style={{ fontSize: 10, color: t.textDim, whiteSpace: "nowrap", minWidth: 70 }}>
