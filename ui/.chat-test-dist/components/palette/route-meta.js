import { Bot, Plug, Server, Cable, Wrench, BookOpen, FileText, Boxes, ClipboardList, Zap, Shield, Key, Webhook, ScrollText, HardDrive, Clock, Hash, } from "lucide-react";
...
export function resolveRouteMetadata(href) {
