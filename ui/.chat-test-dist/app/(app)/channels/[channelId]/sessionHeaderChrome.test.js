...
import { resolveHeaderMetrics, resolveRouteSessionChrome, } from "./sessionHeaderChrome.js";
...
test("route session chrome compacts long titles", () => {
    const chrome = resolveRouteSessionChrome(true, "ok i want to plan to make some widget updates. can you review the @skill:widgets and come up with some improvements?", "Apr 23, 09:05 AM");
