export function resolveWidgetThemeTokens(theme, fallback, isDark) {
 ...
 */
export function buildWidgetThemeCss({ tokens: t, isDark, theme }) {
    return `
  :root {
 ...
 */
export function buildWidgetThemeObject({ tokens: t, isDark, theme }) {
    return {
        isDark,
