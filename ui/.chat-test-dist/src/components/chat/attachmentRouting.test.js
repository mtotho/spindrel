...
import { CHANNEL_DATA_UPLOAD_MAX_BYTES, CHAT_INLINE_IMAGE_MAX_BYTES, decideAttachmentRoute, formatFileSize, } from "./attachmentRouting.js";
function fileLike(type, size) {
    return { type, size };
}
