...
export function resolveChannelLinkedFilePath(href) {
    ...
    if (!normalized)
        return null;
    if (!normalized.includes("/") && !FILE_LIKE_BASENAME_RE.test(normalized))
        return null;
    return normalized.replace(/^\.\//, "");
}
export function resolveToolTargetFilePath(target) {
...
export function resolveMemoryFilePath(target, botId) {
