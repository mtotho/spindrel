...
import { isHarnessQuestionTransportMessage, isPendingHarnessQuestionMessage, pendingHarnessQuestionTurnIds, } from "./harnessQuestionMessages.js";
...
test("harness question answer transport rows are hidden from transcript lists", () => {
    assert.equal(isHarnessQuestionTransportMessage(makeMessage({
        role: "user",
