...
test("Starboard is an object inspector and Mission Control Review owns decisions", () => {
  ...
  assert.match(deckSource, /agent-readiness-autofix-queue/);
  assert.match(deckSource, /Agent readiness autofix/);
  assert.match(deckSource, /applyAgentReadinessRepair/);
  assert.match(deckSource, /mission_control_review/);
  ...
  assert.match(hubPageSource, /attentionLoading/);
  assert.match(hubPageSource, /loading=\{attentionLoading\}/);
  ...
  assert.match(deckSource, /StartingSweepReceipt/);
  assert.match(deckSource, /Operator feed/);
  assert.match(deckSource, /attention-run-feed/);
  ...
  assert.match(deckSource, /Sweep history/);
  assert.match(deckSource, /RunReceipt/);
  assert.match(deckSource, /attention-run-receipt/);
  assert.match(deckSource, /chatMode="terminal"/);
  assert.doesNotMatch(deckSource, />Transcript evidence</);
