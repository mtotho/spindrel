 ...
 * carrying unused tools/skills; tap → first offender's Tools & Skills
 * page (single offender → that bot; many → top-scoring offender).
 */
export function BloatSection() {
  ...
  const href = top
    ? `/admin/bots/${encodeURIComponent(top.bot_id)}#tools`
    : "/admin/usage";
