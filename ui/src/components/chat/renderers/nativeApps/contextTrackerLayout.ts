export type ContextTrackerLayoutMode = "compact" | "standard" | "tall" | "wide";
export type ContextTrackerSurface = "chip" | "header" | "rail" | "dock" | "grid" | undefined;

export interface ContextTrackerLayoutProfile {
  mode: ContextTrackerLayoutMode;
  statColumns: 2 | 3 | 4;
  ...
  showTurnsInContext: boolean;
}

export function deriveContextTrackerLayoutProfile(
  layout: ContextTrackerSurface,
  gridDimensions: { width: number; height: number } | undefined,
): ContextTrackerLayoutProfile {
