...
import {
  applyChatStyleSideEffect,
  resolveChatModeFromStyleResult,
} from "./slashStyleSideEffects.js";
...
test("/style updates the live channel cache key used by channel pages", () => {
  let cached: any = { id: "chan-1", config: { chat_mode: "default", other: true } };
  ...
  applyChatStyleSideEffect(qc as any, "chan-1", {
    command_id: "style",
    result_type: "side_effect",
    payload: {
      effect: "style",
