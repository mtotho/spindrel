/**
 * Shared bot/channel color utilities for Mission Control pages.
 *
 * Consolidates the duplicated hash-based color logic from index.tsx,
 * journal.tsx, memory.tsx, and kanban.tsx.
 */
