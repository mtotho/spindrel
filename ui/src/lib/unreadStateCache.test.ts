...
import { mergeUnreadStateUpdates, recomputeUnreadChannels, type CachedSessionReadState } from "./unreadStateCache.js";

function state(sessionId: string, channelId: string | null, count: number, latest: string | null): CachedSessionReadState {
  return {
    user_id: "user",
